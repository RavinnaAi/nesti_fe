    ...
    <div>
      ...
      <div className="relative" ref={dropdownRef}>
        <button
          ...
          onFocus={onFocus}
          onBlur={onBlur}
          className={`w-full h-14 border-2 rounded-xl px-4 pr-12 transition-all duration-200 hover:shadow-md focus:ring-2 bg-white cursor-pointer text-left flex items-center ${
            error
