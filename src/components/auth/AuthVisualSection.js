    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col items-center justify-center p-8 md:p-12 lg:p-16">
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: isSignup ? 0.4 : 0.6, duration: 0.6 }}
        ...
        <motion.div
          ...
          className={`absolute top-20 right-10 w-20 h-20 backdrop-blur-sm rounded-2xl shadow-lg hidden lg:block ${
            isSignup ? "bg-white/40" : "bg-background/40"
          }`}
        />
        <motion.div
          animate={{ y: [0, 15, 0], rotate: [0, -5, 0] }}
          transition={{ duration: 7, repeat: Infinity, ease: "easeInOut" }}
          className={`absolute bottom-32 left-10 w-16 h-16 backdrop-blur-sm rounded-xl shadow-lg hidden lg:block ${
            isSignup ? "bg-white/40" : "bg-background/40"
          }`}
        />
      </div>
