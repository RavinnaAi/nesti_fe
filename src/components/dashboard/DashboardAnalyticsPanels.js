          ...
          <div className="h-[240px] w-full min-w-0">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={intentTrend} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
                ...
                <Line type="monotone" dataKey="buyers" name="Buyers" stroke="#2563eb" strokeWidth={2.5} dot={false} />
                <Line type="monotone" dataKey="sellers" name="Sellers" stroke="#16a34a" strokeWidth={2.5} dot={false} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
          ...
          <div className="h-[240px] w-full min-w-0">
            <ResponsiveContainer width="100%" height="100%">
              <LineChart data={budgetTrend} margin={{ top: 8, right: 8, left: 0, bottom: 0 }}>
                ...
                />
                <Line type="monotone" dataKey="budget_avg" name="Avg budget" stroke="#8b5cf6" strokeWidth={2.5} dot={false} />
              </LineChart>
            </ResponsiveContainer>
          </div>
        </div>
